	...
	<%@include file="include/mypage.jsp" %>		
			...
			<div class="col-xl-9 col-lg-8 col-md-7">
				...
				<section class="lattest-product-area pb-40">
					<div class="row">
					<h2 class="title">배송지 추가</h2>
						<div class="container">
				            <div class="cart_inner">
				                <div class="table-responsive">
     	                  			<form name="addrForm" action="${pageContext.request.contextPath}/addressManage/add" method="post">
					                    <table id="userModify-table" class="userModify-table">
					                    	<tbody>
					                    		<tr>
					                    			<td class="td_title">*수령인</td>
					                    			<td class="td_content"><input class="large-input" type="text" name="recipient">
					                    		...
					                    		<tr>
					                    			...
					                    			<td class="td_content">
						                    			<table class="inner-table">
						                    				<tr>
							                    				<td><input class="addr1" type="text" name="addr1" placeholder="우편 번호" readonly="readonly">
						                    				...
						                    				<tr>
							                    				<td><input class="large-input" type="text" name="addr2" placeholder="기본 주소" readonly="readonly"></td>
						                    				</tr>
						                    				<tr>
							                    				<td><input class="large-input" type="text" name="addr3" placeholder="상세 주소"></td>
						                    				</tr>
						                    				<tr>
					                    		...
					                    		<tr>
					                    			...
					                    			<td class="td_content"><input class="large-input" type="text" name="tel"> 
					                    ...
					                    <div class="checkbox-group">
					                    	<input id="checkbox"type="checkbox" name="depth" value="0"><label class="label" for="checkbox">기본배송지로 설정</label>
					                    </div>
			                    		<div class="btn-group">
